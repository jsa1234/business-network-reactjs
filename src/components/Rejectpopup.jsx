...
const Rejectpopup = ({ handleModalClose,busid }) => {
  ...
  return (
    <div className="qr-modal fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 ">
      <div className="modal-content bg-white p-6 rounded-lg w-[55rem]  relative">
        <button
