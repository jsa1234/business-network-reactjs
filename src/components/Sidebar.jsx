...
import ForumIcon from "../../public/assests/icons/fourm.svg";
        ...
        <div>
          <nav className="left__navbar">
            <ul>
              ...
              <li
                className={
                  pathName.includes("/quotationrequest") &&
                  pathName !== "/quotationrequest/openquotation"
                    ? "active"
                    : ""
                }
              >
              ...
              <li
                className={pathName.includes("purchaserequest") ? "active" : ""}
              >
              ...
              <li
                className={pathName.includes("openquotation") ? "active" : ""}
              >
              ...
              <li
                className={pathName.includes("businessnetwork") ? "active" : ""}
              >
              ...
              <li
                className={pathName.includes("managenetwork") ? "active" : ""}
              >
              ...
              <li
                className={pathName.includes("forum") ? "active" : ""}
              >
                <Link href="/forum">
                  <ForumIcon />
                  <h2>Biz Forum</h2>
              ...
              <li>
                <div className="left__navbar__card">
                  ...
                  <hr />
                  <p>
                    You can find the current supply chain by using GST/ Name /
                    Phone number
                  </p>
                  {/* <input
