      ...
      <div className="bus__body w-full pl-9 mt-6 pr-3 pb-9">
        <div className="flex justify-between">
          ...
          <div className="w-full md:w-1/2 flex justify-end">
            <button className="primary__btn" onClick={handleButtonClick}>
              Add List <Searchvisual />
            </button>
          </div>
        </div>
      ...
      {showModal && (
        <div className="bus-modal">
          <div className="bus-modal-content">
            ...
            ></input>
            <button className="primary__btn" onClick={handleModalSearch}>
              Search Now <SearchBtn></SearchBtn>
            </button>
