            ...
            {data.map((row) => (
              ...
              >
                ...
                <TableCell align="right flex">
                    <button className={checkList.includes(row.name)?"secondary__btn__light":"secondary__btn"} onClick={()=>handleRowclick(row.name)}><TickIcon/>{!checkList.includes(row.name)?"Select":''}</button>
                    &nbsp;&nbsp;<button className="secondary__btn__light"><HoldIcon/>Hold</button>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
