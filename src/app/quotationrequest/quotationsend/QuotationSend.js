    ...
    <div className="w-full table-container">
      <div className="filter-group">
        <div className="info-container">
          <p>QR ID: <span className="info-details">#2024ABC</span></p>
          <p>Name:<span className="info-details"> Earthly Delights Trading</span></p>
          <p>Requested Date:<span className="info-details">  18/10/2024</span></p>
          <p>Submitted Date:<span className="info-details">  19/10/2024</span></p>
          <p>Expected Delivery Date: <span className="info-details"> 22/10/2024</span></p>
          <p>Total Items:<span className="info-details"> 10</span></p>
        </div>
      </div>
